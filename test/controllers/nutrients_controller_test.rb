...
class NutrientsControllerTest < ActionController::TestCase
  ...
  test "should create nutrient" do
    assert_difference('Nutrient.count') do
      post :create, nutrient: { manufacturer: @nutrient.manufacturer, price: @nutrient.price, title: @nutrient.title, unit: @nutrient.unit }
    end
  ...
  test "should update nutrient" do
    patch :update, id: @nutrient, nutrient: { manufacturer: @nutrient.manufacturer, price: @nutrient.price, title: @nutrient.title, unit: @nutrient.unit }
    assert_redirected_to nutrient_path(assigns(:nutrient))
  end
